...
def create_GoC(
    ...
    if loadParamsFromFile:
        ...
        if pfile.exists():
            ...
            if runid < len(params_list):
                ...
                gc_file_nml = ('Harsha/GoC_' + format(gc_id, '05d') +
                               '.cell.nml')
                print(gc_file_nml)
    ...
    intracellular = (read_nml.cell2_ca_poolses[0].
    ...
    chan_leak = nml.ChannelDensity(ion_channel=idstr,
    ...
    chan_nat = nml.ChannelDensity(ion_channel=idstr,
    ...
    chan_lva = nml.ChannelDensityNernstCa2(ion_channel=idstr,
