...
def create_GoC_nml(
    ...
    if read_gChannelFile:
        ...
        if runid < len(params_list):
            ...
            goc_file_nml = ('Harsha/GoC_' + format(goc_id, '05d') +
                            '.cell.nml')
    ...
    chan_na = nml.ChannelDensity(ion_channel=idstr,
    ...
    chan_nap = nml.ChannelDensity(ion_channel=idstr,
    ...
    chan_nar = nml.ChannelDensity(ion_channel=idstr,
    ...
    chan_ka = nml.ChannelDensity(ion_channel=idstr,
    ...
    chan_sk = nml.ChannelDensity(ion_channel=idstr,
    ...
    chan_kv = nml.ChannelDensity(ion_channel=idstr,
    ...
    chan_km = nml.ChannelDensity(ion_channel=idstr,
    ...
    chan_bk = nml.ChannelDensity(ion_channel=idstr,
    ...
    chan_h1f = nml.ChannelDensity(ion_channel=idstr,
    ...
    chan_h1s = nml.ChannelDensity(ion_channel=idstr,
    ...
    chan_h2f = nml.ChannelDensity(ion_channel=idstr,
    ...
    chan_h2s = nml.ChannelDensity(ion_channel=idstr,
    ...
    chan_hva = nml.ChannelDensityNernst(ion_channel=idstr,
    ...
    chan_lva = nml.ChannelDensityNernst(ion_channel=idstr,
    ...
    if GIRK:
        ...
        chan_girk = nml.ChannelDensity(ion_channel=idstr,
                                       cond_density=gstr,
                                       erev=erev_k,
                                       ion='k',
...
if __name__ == '__main__':
    ...
    res = create_GoC_nml(runid=runid, add2CaPools=add2CaPools,
                         girk_cond=girk_cond)
    print(res)
